...
1. Once the order was placed, the app will check if there is enough inventory to fulfill the request.
    ...
    1.  If there is enought inventory, the app will display the total cost, and deduct the number of unit/s from inventory to reflect the current inventory on hand.
...
![Inventory for item 9 was depleted by 2.](./images/inventory.png)
    ...
    1.  If not, the app will log a phrase  `Insufficient quantity!`, and then prevent the order from going through.     
